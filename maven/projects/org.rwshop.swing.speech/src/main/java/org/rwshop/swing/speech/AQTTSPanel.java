...
public class AQTTSPanel extends javax.swing.JPanel {
	private static final Logger theLogger = LoggerFactory.getLogger(AQTTSPanel.class);
	...
	private void connect(String broker) {
		...
		if (context == null) {
			theLogger.warn("Unable to connect speech Service.  "
	...
	private void bindSpeechPanel(BundleContext context) {
		...
		new OSGiComponent(context, new GenericLifecycle<>(
