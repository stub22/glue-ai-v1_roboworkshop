...
import org.rwshop.swing.animation.table.motionpath.MotionPathTable;
...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
	private static final String PREFERRED_ID = "MotionPathViewTopComponent";

	public MotionPathViewTopComponent() {
		initComponents();
		myContent = new InstanceContent();
		associateLookup(new AbstractLookup(myContent));
		myTable = new MotionPathTable();
		setComponent(myTable);
		setName(NbBundle.getMessage(MotionPathViewTopComponent.class, "CTL_MotionPathViewTopComponent"));
		setToolTipText(NbBundle.getMessage(MotionPathViewTopComponent.class, "HINT_MotionPathViewTopComponent"));
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
	 ...
	 */
	public static synchronized MotionPathViewTopComponent getDefault() {
		if (instance == null) {
			instance = new MotionPathViewTopComponent();
		}
		return instance;
	}

	/**
	 * Obtain the MotionPathViewTopComponent instance. Never call {@link #getDefault} directly!
	 */
	public static synchronized MotionPathViewTopComponent findInstance() {
		TopComponent win = WindowManager.getDefault().findTopComponent(PREFERRED_ID);
		if (win == null) {
			LoggerFactory.getLogger(MotionPathViewTopComponent.class.getName()).warn(
					"Cannot find " + PREFERRED_ID + " component. It will not be located properly in the window system.");
			return getDefault();
		}
		if (win instanceof MotionPathViewTopComponent) {
			return (MotionPathViewTopComponent) win;
		}
		LoggerFactory.getLogger(MotionPathViewTopComponent.class.getName()).warn(
