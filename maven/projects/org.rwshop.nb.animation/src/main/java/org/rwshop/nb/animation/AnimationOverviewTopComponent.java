 ...
 */
@ConvertAsProperties(dtd = "-//org.rwshop.nb.animation//AnimationOverview//EN",
		autostore = false)
...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
	...
	public AnimationOverviewTopComponent() {
		...
		myPanel = new TimelineOverviewPanel();
...
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
	...
	/**
	 * Obtain the AnimationOverviewTopComponent instance. Never call {@link #getDefault} directly!
	 */
	public static synchronized AnimationOverviewTopComponent findInstance() {
		TopComponent win = WindowManager.getDefault().findTopComponent(PREFERRED_ID);
		if (win == null) {
			LoggerFactory.getLogger(AnimationOverviewTopComponent.class.getName()).warn(
