...
//    private ServiceChildren myServiceChildren;
	...
	public void start(BundleContext context) throws Exception {
		java.util.logging.Logger.getLogger("org.netbeans.core.netigso.Netigso").setLevel(Level.WARNING);
		theLogger.info("Activating NetBeans Adapter Bundle");
		setFileSystem(context);
		initSettings();
		startVisemes(context);
		theLogger.info("NetBeans Adapter Bundle Activation Complete");
	}
