 ...
 */
public class AnimationTableLayoutListener implements ComponentListener{
    @Override
     ...
     * @param table
     */
    protected void setTableLayout(JTable table){
        ...
        TableColumn colColor = table.getColumn("Color");
        TableHelper.setColumnWidth(colColor, 26);
