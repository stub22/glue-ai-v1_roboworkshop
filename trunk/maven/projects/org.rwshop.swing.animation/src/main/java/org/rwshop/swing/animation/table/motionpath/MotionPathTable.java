    ...
    private void initComponents() {
        ...
        myTable = new javax.swing.JTable() {
            ...
            public boolean editCellAt(int row, int column, EventObject e){
                ...
                final java.awt.Component editor = getEditorComponent();
                Class text = JTextComponent.class;
                Class mouse = java.awt.event.MouseEvent.class;
                if(editor == null || !text.isInstance(editor)){
                    return result;
                }
                if(mouse.isInstance(e)){
