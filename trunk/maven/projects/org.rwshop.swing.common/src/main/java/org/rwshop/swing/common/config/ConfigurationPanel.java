...
public class ConfigurationPanel extends javax.swing.JPanel {
	...
	private static final Logger theLogger = LoggerFactory.getLogger(ConfigurationPanel.class);
	...
	private void addConfigurationPanel(String s) {
		...
		if (newConfig.equals(myConfig)) {
			...
			theLogger.warn("Cannot add a configuration to itself.");
			return;
		}
